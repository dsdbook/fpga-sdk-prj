...
create_clock  -name DRAM_CLK            -period 10 [get_ports {DRAM_CLK}]



create_generated_clock  -source CLK2_50 \
                        -divide_by 5 \
                        -multiply_by 2 \
                        -duty_cycle 50.00 \
                        -name CLK_RISCV \
                        [get_nets {i_pll|altpll_component|auto_generated|wire_generic_pll1_outclk}]

create_generated_clock  -source CLK2_50 \
                        -multiply_by 2 \
                        -duty_cycle 50.00 \
                        -name CLK_SDRAM \
                        [get_nets {i_pll|altpll_component|auto_generated|wire_generic_pll2_outclk}]
...
create_generated_clock  -source CLK2_50 \
                        ...
                        -duty_cycle 50.00 \
                        -name CLK_SDRAM_EXT \
                        [get_nets {i_pll|altpll_component|auto_generated|wire_generic_pll3_outclk}]
...
set_clock_groups -asynchronous -group {CLK2_50}
